...
CORS(app, origins=["http://localhost:3000", "http://192.168.178.17:3000", "http://192.168.2.8:3000", "http://192.168.56.1:3000", "http://145.137.104.145:3000"], supports_credentials=True)
# talisman = Talisman(
#     app,
